...
PERMISSION_CATALOG: Dict[str, List[Dict[str, str]]] = {
    ...
    "Appointments": [
        ...
        {"key": "waiting_list.view", "label": "View waiting list"},
        {"key": "waiting_list.create", "label": "Add waiting list entries"},
        {"key": "waiting_list.update", "label": "Update waiting list entries"},
        {"key": "waiting_list.cancel", "label": "Cancel waiting list entries"},
        {"key": "waiting_list.convert_to_appointment", "label": "Convert waiting list to appointment"},
        {"key": "waiting_list.report", "label": "View waiting list reports"},
...
SYSTEM_ROLE_DEFINITIONS = [
    ...
    },
    {
        ...
        "permissions": sorted({
            ...
            "appointments.override_conflict", "bookings.create_overtime",
            "waiting_list.view", "waiting_list.create", "waiting_list.update", "waiting_list.cancel",
            "waiting_list.convert_to_appointment", "waiting_list.report",
            "coupons.manage", "campaigns.view", "campaigns.manage",
    ...
    },
    {
        ...
        "permissions": sorted({
            ...
            "appointments.view", "appointments.create", "appointments.edit", "appointments.cancel",
            "waiting_list.view", "waiting_list.create", "waiting_list.update", "waiting_list.cancel",
            "waiting_list.convert_to_appointment",
